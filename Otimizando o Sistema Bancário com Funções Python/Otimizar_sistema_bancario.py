...
def sacar(*, sacar, valor, extrato, limite, numero_saques, limite_saques):
...
def criar_usuario(usuarios):
     ...
     if usuario:
          print("Já existe este usuário de CPF")
          return
     nome = input("Informe o nome completo:")
     data_nascimento = input("Informe a data de nascimento(dd--mm-aaaa):")
     endereco = ("Informe o endereço (Logradouro,nn bairro cidade/estado):")
